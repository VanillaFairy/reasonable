...
//
// Each work order also projects its fixed PIPELINE SCAFFOLD (provision → … → audit, done/
// active/pending) with the live heartbeat folded into the active stage and the acting agent's
// own todo list nested beneath. Atomic-action lines are ordered by `seq` (the monotonic
