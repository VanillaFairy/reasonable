...
// context / selector to mock: `useStore`, `useContext`, `NodesContext`). The remaining
// prose (the shape to return, how to trigger the scenario) is model-read, not parsed, so
// `raw` always carries the full first line. `mock` is the hint the optional auditor smell
// ("every test mocks X to the same empty default") keys off.
