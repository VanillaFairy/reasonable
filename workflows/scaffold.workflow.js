...
function verdictWriterPrompt(a, verdict, contract, build) {
  return [
    ...
    'Add the `commit` field from the code commit/hash the contract landed (`commit` = ' + (build.commit || 'the live skeleton commit') + ') into the JSON payload before you call the CLI - do not invent it. The controller stamps `seq` and `ts` itself; you do not add or read them.',
